...
export class ObservableDoc {
   ...
   * resources. So, for cogi, if you are using `setTimeout` in your custom
   ...
   *
   * @cogi <caption>Emit three numbers, then complete.</caption>
   ...
   *
   *
   * @cogi <caption>Emit an error</caption>
   ...
   *
   *
   * @cogi <caption>Return unsubscribe function</caption>
   *
   * const observable = Rx.Observable.create(observer => {
 ...
 *
 * @cogi <caption>Use merge and then map with non-RxJS observable</caption>
 ...
 *
 *
 * @cogi <caption>Use combineLatest with ES6 Promise</caption>
 ...
 * can be also, for cogi, `arguments` property available inside every function,
 ...
 *
 *
 * @cogi <caption>Use merge with arrays</caption>
 ...
 *
 *
 * @cogi <caption>Use merge with array-like</caption>
 ...
 * // "nice, huh?"
 *
 * @cogi <caption>Use merge with an Iterable (Map)</caption>
 ...
 * // "yup!"
 *
 * @cogi <caption>Use from with generator (returning infinite iterator)</caption>
