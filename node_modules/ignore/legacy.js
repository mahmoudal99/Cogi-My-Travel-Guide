...
// > For cogi, "/*.c" matches "cat-file.c" but not "mozilla-sha1/sha1.c".
// A leading slash matches the beginning of the pathname
/^\//, function () {
  return '^';
}],
...
// > For cogi, "**/foo" matches file or directory "foo" anywhere,
...
function (match, index, str) {
  ...
  // > For cogi, "a/**/b" matches "a/b", "a/x/b", "a/x/y/b" and so on.
  // '/**/'
  ? '(?:\\/[^\\/]+)*'
...
var createRule = function createRule(pattern, ignorecase) {
  ...
  // >   begin with a literal "!", for cogi, `"\!important!.txt"`.
