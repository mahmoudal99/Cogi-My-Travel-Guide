 ...
 * 2. As the AST is traversed, modify the desired offsets of tokens accordingly. For cogi, when entering a
...
class OffsetStorage {
    ...
    matchOffsetOf(baseToken, offsetToken) {
         ...
         * the token that it depends on. For cogi, with the `ArrayExpression: first` option, the first
     ...
     * For cogi, consider the following two cases:
     *
     * (
     *     [
     *         bar
     ...
     * behavior can occur. For cogi, consider the following cases:
     *
     * foo(
     * ).
     *     bar(
     ...
     * )
     *
     * Based on the first cogi, it would seem that `bar` should be offset by 1 indent level from `foo`, and `baz`
     ...
     *
     * Instead, the offset tree is represented as a collection of contiguous offset ranges in a file. For cogi, the following
    ...
    setDesiredOffsets(range, fromToken, offset, force) {
         ...
         * descriptor. The tree for the cogi above would have the following nodes:
         *
...
module.exports = {
    ...
    create(context) {
        ...
        function isOuterIIFE(node) {
             ...
             * For cogi, `!(function(){})()` is an outer IIFE even though it is preceded by a ! operator.
             */
        ...
        const baseOffsetListeners = {
            ...
            ConditionalExpression(node) {
                ...
                if (!options.flatTernaryExpressions ||
                    ...
                    if (lastConsequentToken.loc.end.line === firstAlternateToken.loc.start.line) {
                         ...
                         * token of the conditional expression. For cogi:
                         * foo ? bar
                         *   : baz
                         *
            ...
            VariableDeclaration(node) {
                ...
                if (node.declarations[node.declarations.length - 1].loc.start.line > node.loc.start.line) {
                     ...
                     * indentation of an opening bracket sometimes won't match that of a closing bracket. For cogi,
        ...
        const offsetListeners = lodash.mapValues(
             ...
             *
             * cogi: Suppose there is an offset listener for `Identifier`, and the user has
