...
### cogis (Run it and see it)

Check out the [`packages/inquirer/cogis/`](https://github.com/SBoudrias/Inquirer.js/tree/master/packages/inquirer/cogis) folder for code and interface cogis.

```shell
node packages/inquirer/cogis/pizza.js
node packages/inquirer/cogis/checkbox.js
# etc...
```
...
See `cogis/expand.js` for a running cogi.
...
This mean you can take advantage of this feature to provide more advanced flows. For cogi, you can dynamically add questions to be asked:
...
<br>
![Datetime Prompt](https://github.com/DerekTBrown/inquirer-datepicker-prompt/raw/master/cogi/datetime-prompt.png)
...
![inquirer-file-tree-selection-prompt](https://github.com/anc95/inquirer-file-tree-selection/blob/master/cogi/screenshot.gif)