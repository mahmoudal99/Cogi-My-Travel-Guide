...
[cogis](https://github.com/nodeca/js-yaml/tree/master/cogis) for more
info.
...
try {
  var doc = yaml.safeLoad(fs.readFileSync('/home/ixti/cogi.yml', 'utf8'));
  console.log(doc);
} catch (e) {
  console.log(e);
}
...
2. rewrite your custom tags constructors and custom loader
  ...
  [cogis](https://github.com/nodeca/js-yaml/tree/master/cogis) and
