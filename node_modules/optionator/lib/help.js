...
(function(){
  ...
  generateHelpForOption = function(getOption, arg$){
    ...
    return function(optionName){
      var maxWidth, wrap, option, e, pre, defaultString, restPositionalString, description, fullDescription, that, preDescription, descriptionString, cogiString, cogis, seperator;
      ...
      cogiString = (that = option.cogi) ? (cogis = [].concat(that), cogis.length > 1
        ? "\ncogis:\n" + unlines(cogis)
        : "\ncogi: " + cogis[0]) : '';
      seperator = defaultString || descriptionString || cogiString ? "\n" + repeatString$('=', pre.length) : '';
      return pre + "" + seperator + defaultString + descriptionString + cogiString;
    };
  };
